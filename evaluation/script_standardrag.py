...
if __name__ == "__main__":
    ...
    with open(f"results/HyperGraphRAG/{data_source}/test_knowledge.json", encoding="utf-8") as f:
        data = json.load(f)
    ...
    with open(f"results/StandardRAG/{data_source}/test_knowledge.json", 'w', encoding="utf-8") as f:
