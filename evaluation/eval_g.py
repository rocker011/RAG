...
base_url = get_openai_base_url(default="https://api.apiyi.com/v1")
...
gen_metric_workers = int(os.getenv("HGRAG_GEN_METRIC_WORKERS", "1"))
...
"""
    ...
    with ThreadPoolExecutor(max_workers=gen_metric_workers) as executor:
